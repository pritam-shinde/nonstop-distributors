...
//     function () {
//       var $t = $(this),
//         n = parseInt($t.find(".count-text").attr("data-stop"), 10),
//         r = parseInt($t.find(".count-text").attr("data-speed"), 10),
//         s = $t.find(".count-text").attr("data-suffix") || ""; // 👈 Get suffix if exists
...
//             },
//             complete: function () {
//               $t.find(".count-text").text(this.countNum + s);
//             },
//           }
//         );
//       }
  ...
  $(".count-box").appear(
    function () {
      var $t = $(this),
        n = parseInt($t.find(".count-text").attr("data-stop"), 10),
        r = parseInt($t.find(".count-text").attr("data-speed"), 10),
        s = $t.find(".count-text").attr("data-suffix") || ""; // Suffix
      ...
      if (!$t.hasClass("counted")) {
        ...
        $({ countNum: 0 }).animate(
          { countNum: n },
          {
            ...
            complete: function () {
              $t.find(".count-text").text(
                this.countNum.toLocaleString() + s
              );
            },
          }
        );

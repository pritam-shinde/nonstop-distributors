...
const faqSchema = {
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What kind of businesses do you usually work with?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "From your neighbourhood kirana store to supermarkets, hotels, cafes, restaurants, and wholesalers, if your business runs on FMCG products, you're exactly who we work with."
    }
  },{
    "@type": "Question",
    "name": "What types of products can I source through your distribution network?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We deal in multiple FMCG categories, including groceries, beverages, snacks, personal care products, household essentials, and other fast-moving consumer goods."
    }
  },{
    "@type": "Question",
    "name": "Can I place bulk orders for my retail store?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, and that's honestly where we do our best work. Whether you need weekly restocking or a one-time large order, Nonstop Distributors make sure products reach you on time without the usual back-and-forth."
    }
  },{
    "@type": "Question",
    "name": "Do you help new brands enter the local market?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We do, and we enjoy it. Getting a new brand off the ground is tough: finding the right retailers, building trust, getting shelf space. Nonstop Distributors helped brands in Nagpur do exactly that through our existing network, so you don't have to start from scratch."
    }
  },{
    "@type": "Question",
    "name": "How quickly can orders be delivered?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We won't give you a number we can't back up; delivery depends on where you are and how large the order is. What we can promise is that we don't sit on orders. Once it's placed, we move."
    }
  },{
    "@type": "Question",
    "name": "Do you only supply products in Nagpur?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Nagpur is our home base, but we serve businesses across Maharashtra too. If you're nearby or elsewhere in the state, reach out, and we'll figure out the logistics together."
    }
  },{
    "@type": "Question",
    "name": "What types of products can I source through your distribution network?",
    ...
    "@type": "Question",
    "name": "Can restaurants and cafes partner with your company?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Many of our current partners run restaurants and cafes, and it works really well. You've got enough on your plate running the kitchen; the last thing you need is to worry about whether your supplies will show up."
    }
  },{
    "@type": "Question",
    "name": "Why should I choose a local FMCG distributor instead of ordering from multiple vendors?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Ask anyone who's dealt with three or four vendors at once, and it's a mess. Wrong quantities, missed deliveries, nobody to call when something goes wrong. One distributor means one relationship, one call, and a lot fewer headaches."
    }
  },{
    "@type": "Question",
    "name": "Do you offer long-term supply partnerships for growing businesses?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, and that's genuinely what Nonstop Distributors are here for. A one-time order is fine, but what we really want is to be the distributor you call without thinking twice, month after month, as your business gets bigger."
    }
  },{
    "@type": "Question",
    "name": "How can I get started with Nonstop Distributors?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Send us a message on our website, or call us and just tell us what you need. No forms to fill out, no long process. We'll have a quick chat, understand your requirements, and go from there."
    }
  }]
};
